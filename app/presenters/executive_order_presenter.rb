class ExecutiveOrderPresenter
  ...
  def description
    ...
    The OFR numbers each order consecutively as part of a series and publishes it in the daily Federal Register shortly after receipt. For a table of Executive orders that are specific to federal agency rulemaking, see https://sourcebook.acus.gov/wiki/White_House_Orders,_Bulletins,_and_Memoranda/view#Table_of_Executive_Order_Requirements."
  end
