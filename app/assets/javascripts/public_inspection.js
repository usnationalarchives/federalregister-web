$(document).ready(function() {
  if( $('.doc-public-inspection .doc-content').length > 0 ) {
    var document_height = $('.doc-public-inspection .doc-content').outerHeight(),
    ...
    if( document_height < sidebar_height + amount_document_should_be_lower_than_sidebar ) {
      $('.doc-content .fr-box.fr-box-public-inspection').css('height', sidebar_height + amount_document_should_be_lower_than_sidebar + side_bar_top_offset);
    }
  }
});
